...
조회 화면:   http://127.0.0.1:4173/report
```

## Python 환경

상태 점검, 데이터 검증, Supabase 업로드, 엑셀 커버리지 점검은 Python 3와 아래 패키지를 사용합니다.
...
Python을 다른 위치에 설치해 쓰는 PC에서는 `DAILY_REPORT_PYTHON`에 실행 파일 경로를 지정합니다.
